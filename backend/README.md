...
#### GET /categories
- General: Returns a dictionary of categories, with id and the type.
...
#### GET /questions
- General: Return a list of questions, number of total questions, current category, categories. Results are paginated in groups of 10.
